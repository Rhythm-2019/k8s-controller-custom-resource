...
func (c *FakeNetworks) Get(ctx context.Context, name string, options v1.GetOptions) (result *simplecrdv1.Network, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(networksResource, c.ns, name), &simplecrdv1.Network{})

	if obj == nil {
		return nil, err
	}
	return obj.(*simplecrdv1.Network), err
}

// List takes label and field selectors, and returns the list of Networks that match those selectors.
func (c *FakeNetworks) List(ctx context.Context, opts v1.ListOptions) (result *simplecrdv1.NetworkList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(networksResource, networksKind, c.ns, opts), &simplecrdv1.NetworkList{})
	...
	list := &simplecrdv1.NetworkList{ListMeta: obj.(*simplecrdv1.NetworkList).ListMeta}
	for _, item := range obj.(*simplecrdv1.NetworkList).Items {
...
func (c *FakeNetworks) Create(ctx context.Context, network *simplecrdv1.Network, opts v1.CreateOptions) (result *simplecrdv1.Network, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(networksResource, c.ns, network), &simplecrdv1.Network{})
...
func (c *FakeNetworks) Update(ctx context.Context, network *simplecrdv1.Network, opts v1.UpdateOptions) (result *simplecrdv1.Network, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(networksResource, c.ns, network), &simplecrdv1.Network{})
...
func (c *FakeNetworks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(networksResource, c.ns, name, opts), &simplecrdv1.Network{})
...
func (c *FakeNetworks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &simplecrdv1.NetworkList{})
	return err
}

// Patch applies the patch and returns the patched network.
func (c *FakeNetworks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *simplecrdv1.Network, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networksResource, c.ns, name, pt, data, subresources...), &simplecrdv1.Network{})
